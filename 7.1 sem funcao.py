...
while not cadastro_completo:
    ...
    cidade = input('Insira a cidaded em que você mora: ')
    ...
    confirmacao = bool(input('Confirme os dados acima. Digite "True" se estiver correto ou "False" se algo estiver errado.'))
